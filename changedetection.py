...
class ChangeDetection:
    ...
    def send(self, save_dir, image):
        ...
        full_path = '{0}-{1}-{2}-{3}.jpg'.format(today.hour, today.minute, today.second, today.microsecond)

        dst = cv2.resize(image.copy(), dsize=(320,240), interpolation=cv2.INTER_AREA)
